package com.budoudoh.bask_it.service;
 ...
 */
public class GimbalBaskitService extends Service {
    ...
    public void onCreate() {
        ...
        Gimbal.setApiKey(this.getApplication(), "0a5b1f7f-067c-42d4-ae0c-4373df57ed1f");
        ...
        communicationListener = new CommunicationListener() {
            ...
            public Collection<Communication> presentNotificationForCommunications(Collection<Communication> communications, Visit visit) {
                ...
                for (Communication communication : communications) {
                    addEvent(new GimbalEvent(GimbalEvent.TYPE.COMMUNICATION_PRESENTED, communication.getTitle() + ":  CONTENT_DELIVERED", new Date(communication.getDeliveryDate())));
                }
            ...
            public Collection<Communication> presentNotificationForCommunications(Collection<Communication> communications, Push push) {
                ...
                for (Communication communication : communications) {
                    addEvent(new GimbalEvent(GimbalEvent.TYPE.COMMUNICATION_INSTANT_PUSH, communication.getTitle() + ":  CONTENT_DELIVERED", new Date(communication.getDeliveryDate())));
                }
